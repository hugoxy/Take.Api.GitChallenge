...
using Take.Api.GitChallenge.Facades.Extensions;
...
namespace Take.Api.GitChallenge
{
    ...
    public class Startup
    {
        ...
        /// <summary>
        /// Add Swagger Authorizations
        /// </summary>
        /// <param name="builder"></param>
        /// <returns></returns>
        public static IApplicationBuilder AddSwaggerAuthorized(IApplicationBuilder builder)
        {
